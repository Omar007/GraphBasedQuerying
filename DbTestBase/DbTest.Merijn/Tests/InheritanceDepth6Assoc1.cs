...
using InheritanceDepth6Assoc1;

namespace DbTest.Merijn.Tests
{
    public class EFMultiQueryDepth6Assoc1 : EFMultiQuery<InheritanceDepth6Assoc1ModelContainer, E00>
    {
        public EFMultiQueryDepth6Assoc1(IDatabaseConnection connection, Population population)
    ...
    public class GraphBasedQueryDepth6Assoc1 : GraphBasedQuery<InheritanceDepth6Assoc1ModelContainer, O>
    {
        public GraphBasedQueryDepth6Assoc1(IDatabaseConnection connection, Population population)
            : base(connection, population)
        {
