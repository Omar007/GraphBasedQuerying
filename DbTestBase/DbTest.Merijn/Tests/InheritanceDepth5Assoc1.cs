...
using InheritanceDepth5Assoc1;

namespace DbTest.Merijn.Tests
{
    public class EFMultiQueryDepth5Assoc1 : EFMultiQuery<InheritanceDepth5Assoc1ModelContainer, E00>
    {
        public EFMultiQueryDepth5Assoc1(IDatabaseConnection connection, Population population)
    ...
    public class GraphBasedQueryDepth5Assoc1 : GraphBasedQuery<InheritanceDepth5Assoc1ModelContainer, O>
    {
        public GraphBasedQueryDepth5Assoc1(IDatabaseConnection connection, Population population)
            : base(connection, population)
        {
