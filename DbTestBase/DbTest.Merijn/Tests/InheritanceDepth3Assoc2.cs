...
{
    public class EFMultiQueryDepth3Assoc2 : EFMultiQuery<InheritanceDepth3Assoc2ModelContainer, E00>
    {
        public EFMultiQueryDepth3Assoc2(IDatabaseConnection connection, Population population)
    ...
    public class GraphBasedQueryDepth3Assoc2 : GraphBasedQuery<InheritanceDepth3Assoc2ModelContainer, O>
    {
        public GraphBasedQueryDepth3Assoc2(IDatabaseConnection connection, Population population)
            : base(connection, population)
        {
