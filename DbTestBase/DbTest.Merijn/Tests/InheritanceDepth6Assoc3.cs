...
using InheritanceDepth6Assoc3;

namespace DbTest.Merijn.Tests
{
    public class EFMultiQueryDepth6Assoc3 : EFMultiQuery<InheritanceDepth6Assoc3ModelContainer, E00>
    {
        public EFMultiQueryDepth6Assoc3(IDatabaseConnection connection, Population population)
    ...
    public class GraphBasedQueryDepth6Assoc3 : GraphBasedQuery<InheritanceDepth6Assoc3ModelContainer, O>
    {
        public GraphBasedQueryDepth6Assoc3(IDatabaseConnection connection, Population population)
            : base(connection, population)
        {
